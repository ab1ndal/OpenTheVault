...
app.layout = dmc.MantineProvider(
    ...
    children=[
        ...
        dmc.Grid([
            dmc.Col([
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Shear - Minimum (kN)', id='shear-min', w=300, value=-2e3),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Axial - Minimum (kN)', id='axial-min', w=300, value=0),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Moment - Minimum (kNm)', id='moment-min', w=300, value=-3e6),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Torsion - Minimum (kNm)', id='torsion-min', w=300, value=-4e5),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Height - Minimum (m)', id='height-min', w=300, value=-60),
            ], span=4),
            dmc.Col([
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Shear - Maximum (kN)', id='shear-max', w=300, value=4e3),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Axial - Maximum (kN)', id='axial-max', w=300, value=3e5),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Moment - Maximum (kNm)', id='moment-max', w=300, value=1e6),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Torsion - Maximum (kNm)', id='torsion-max', w=300, value=1e5),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Height - Maximum (m)', id='height-max', w=300, value=30),
            ], span=4),
            dmc.Col([
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Shear - Step Size (kN)', id='shear-step', w=300, value=2e3),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Axial - Step Size (kN)', id='axial-step', w=300, value=5e4),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Moment - Step Size (kNm)', id='moment-step', w=300, value=1e6),
                dmc.NumberInput(min=-9999999, max=9999999,precision=3,label='Torsion - Step Size (kNm)', id='torsion-step', w=300, value=2e5),
